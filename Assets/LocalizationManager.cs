...
public class LocalizationManager : MonoBehaviour
{
    ...
    void Awake()
    {
        if (!PlayerPrefs.HasKey("Language"))
        {
            ...
            {
                PlayerPrefs.SetString("Language", "zh_ZH");
            }
            else
            {
        ...
        {
            GlobalBase.NomberOfLanguage = 1;
        }
        else if (currentLanguage == "zh_ZH")
        {
            GlobalBase.NomberOfLanguage = 2;
        }
        else
        {
            GlobalBase.NomberOfLanguage = 0;
        }
